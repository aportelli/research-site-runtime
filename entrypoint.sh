...
log "performing initial checkout of ref $GITSYNC_REF"
git-sync "${sync_args[@]}" --one-time
log "initial checkout complete; building the first release"
/runtime/refresh.sh
log "initial release is ready; starting Nginx on port 8080"
